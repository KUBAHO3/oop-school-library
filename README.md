...
- [📖-Decode-a-Morse-code-message](#-OOP SCHOOL LIBRARY-)
...
**OOP SCHOOL LIBRARY** is a Ruby-based project
...
This project is [MIT](https://github.com/KUBAHO3/oop-school-library/blob/add-classes/MIT.md) licensed.
